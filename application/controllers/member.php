...
class member extends MY_Controller
{
    ...
    function edit()
    {
        ...
        //分别获取省 市 县
        $data['sheng'] = $this->m_cityaddress->getfiststepAll();
        $data['shi'] = $this->m_cityaddress->getbyparentid($cityarr[0]);
        $data['xian'] = $this->m_cityaddress->getbyparentid($cityarr[1]);
    ...
    function deleteregbyid()
    {
        ...
        if($res)
        {
            alert('删除成功','jump','/member/registraionlist');
        }
        else{
            alert('删除失败','jump','/member/registraionlist');
        }
    }
    ...
    function timeout()
    {
        ...
        $res = $this->m_members->updateMemberById($updatearr);
        if($res)
        {
            alert('操作成功','jump','/member');
        }else
        {
            alert('操作失败','jump','/member');
        }
